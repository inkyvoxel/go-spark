...
- Remove concept of 'app_env' test/prod - show warning for misconfigurations instead of failing the app, unless the env variables were required (such as pepper, secret base). Intention is to simplify the logic in the app
