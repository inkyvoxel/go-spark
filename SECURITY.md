...
* Set `SECRET_KEY_BASE` and keep it out of version control — it signs flash messages and the TOTP/passkey ceremony cookies. It is cheap to rotate; no stored data depends on it.
